...
@RestController //create RESTful web services using Spring MVC and handle mapping request
public class EmployeeController {
	...
	public void setAllEmployee() {
		emp.add(new Employee(1,"Sanika","HR"));
		emp.add(new Employee(2,"Kavita","Sales"));
		emp.add(new Employee(3,"Rucha","Marketing"));
	}
